...
describe("AC-6: the column method is enumerated, implemented and cited", () => {
  ...
  test("AC-6: the platform seed is IS1200_IN @ 2026.11 and cites every method the shards enumerate", async () => {
    ...
    // Re-baselined by the foundations leaf: its seven methods are minted at the next version beside
    // the standing 2026.10 rather than over it — an edition is immutable (L-MEA-01, B-20).
