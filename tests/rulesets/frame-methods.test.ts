...
/**
 * The version the platform edition is re-minted at (AC-2), re-baselined by the foundations leaf: an
 * edition is immutable, so its seven new methods are minted at the next version beside 2026.10
