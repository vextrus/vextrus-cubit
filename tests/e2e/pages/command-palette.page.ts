...
export class CommandPalettePage {
  ...
  get loading(): Locator {
    return this.page.getByTestId("command-palette-loading");
  }
  ...
  group(id: string): Locator {
    return this.page.locator(`[data-testid="command-palette-group"][data-group="${id}"]`);
  }

  /** The rows of one group, in document order. */
  rows(id: string): Locator {
    return this.page.locator(`[data-testid="command-palette-group"][data-group="${id}"] [data-testid="command-palette-item"]`);
  }
  ...
  get reason(): Locator {
    return this.page.getByTestId("command-palette-item-reason");
  }
  ...
  sheetKeys(shortcutId: string): Locator {
    return this.page.locator(`[data-testid="shortcut-sheet-row"][data-shortcut="${shortcutId}"] [data-testid="shortcut-sheet-keys"]`);
  }
