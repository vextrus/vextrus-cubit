...
export const S_DRAWINGS = {
  index: TESTIDS.sheet.index,
  card: TESTIDS.sheet.card,
  thumbnail: TESTIDS.sheet.cardThumbnail,
  title: TESTIDS.sheet.cardTitle,
  number: TESTIDS.sheet.cardNumber,
  ...
  open: TESTIDS.sheet.cardOpen,
  fact: TESTIDS.sheet.fact,
  disciplineOption: TESTIDS.sheet.disciplineOption,
  confirm: TESTIDS.sheet.confirm,
  search: TESTIDS.sheet.search,
  filterOption: TESTIDS.sheet.filterOption,
  empty: TESTIDS.sheets.empty,
  timeline: TESTIDS.job.timeline,
  timelineStep: TESTIDS.job.timelineStep,
  timelineStepTiming: TESTIDS.job.timelineStepTiming,
  jobsTray: TESTIDS.shell.jobsTray,
  jobsTrayPanel: TESTIDS.shell.jobsTrayPanel,
  jobsTrayItem: TESTIDS.shell.jobsTrayItem,
  /** The item's elapsed cell: it stands in every state, holding the bone while no number exists. */
  jobsTrayItemTiming: TESTIDS.shell.jobsTrayItemTiming,
  jobsTrayEmpty: TESTIDS.shell.jobsTrayEmpty,
  groups: TESTIDS.offered.groups,
  group: TESTIDS.offered.group,
  groupCount: TESTIDS.offered.groupCount,
  groupConfirm: TESTIDS.offered.groupConfirm,
  dropzone: TESTIDS.dropzone.root,
  dropzoneInput: TESTIDS.dropzone.input,
  dropzoneItem: TESTIDS.dropzone.item,
  dialog: TESTIDS.consequence.dialog,
  dialogSubject: TESTIDS.consequence.subjectRow,
  dialogDigest: TESTIDS.consequence.digestLine,
  dialogConfirm: TESTIDS.consequence.confirm,
  dialogStale: TESTIDS.consequence.staleNotice,
} as const;
