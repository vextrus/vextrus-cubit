...
// — and every deep import into the seam's interior is refused outside the seam directory.
...
export const reached = { Anthropic, OpenAI, transport, streamed, hoisted, required, computed, indirect };
