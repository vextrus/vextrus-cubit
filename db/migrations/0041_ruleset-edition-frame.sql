...
--
-- What it cites is every method the shards enumerate (`enumerateMethods()`), which is now nine pairs:
-- the three 2026.09 cited and the six the FRAME area records for L-MEA-09's beams, tie beams and
-- lintels. A pair the tree can compute and no edition cites is a method in force that nothing in
