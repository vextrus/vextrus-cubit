...
ALTER TABLE "quantity_lines" ADD COLUMN "selection_basis" text NOT NULL;--> statement-breakpoint
ALTER TABLE "quantity_lines" ADD COLUMN "omitted" json NOT NULL;--> statement-breakpoint
