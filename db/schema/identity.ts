// Identity, as the schema tree offers it to drizzle-kit. The definitions themselves live in the
...
export { authAttempts, authTokens, memberships, sessions, users } from "../../src/core/db";
