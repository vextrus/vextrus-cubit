// The FOUNDATIONS area’s tables, as the schema tree offers them to drizzle-kit — empty until M3 writes them
...
// src/core/db/schema-foundations.ts, spells it in src/core/db.ts’s roster, and re-exports it here.
export {};
