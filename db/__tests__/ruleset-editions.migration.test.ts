 ...
 *
 * Re-baselined under B-20 by the frame leaf, which mints a THIRD row, and again by the slab,
 * shear-wall and stair leaf, which mints a FOURTH. The reading is the one this case always made — a
 ...
 */
const MINTED_SEED_VERSIONS: readonly string[] = [SUPERSEDED_SEED_VERSION, "2026.09", "2026.10", SEED_VERSION];
