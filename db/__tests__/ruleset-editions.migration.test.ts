 ...
 * masonry, rebar and slabs leaves, each of which mints one more. The reading is the one this case
 * always made — a re-mint is "inserted BESIDE the immutable row, never over it" — and it is the
 ...
 */
const MINTED_SEED_VERSIONS: readonly string[] = [SEEDED_SEED_VERSION, "2026.09", "2026.10", "2026.11", "2026.12", SUPERSEDED_SEED_VERSION, SEED_VERSION];
