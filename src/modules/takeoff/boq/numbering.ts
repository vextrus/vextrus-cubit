...
// question. So the derivation stands where BOTH can reach it — `src/core/documents/kinds/boq-draft.ts`,
// beside the presenter that prints it, because ARCH-01 forbids the document seam to import this
// module — and this file publishes it to the takeoff module under the name the interfaces give it.
//
...
export { numberItems } from "@/core/documents/kinds/boq-draft";
export type { NumberableGroup, NumberableLine, NumberableSection } from "@/core/documents/kinds/boq-draft";
