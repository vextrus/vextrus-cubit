// The MASONRY area's rails: the brickwork a mason builds, and the plaster and paint laid on a face.
//
...
import { brickworkRail, paintRail, plasterRail } from "./masonry-finishes/index";

/** Every kind this area measures, and the pure function that measures it (L-MEA-08). */
export const MASONRY_RAILS: RailRoster = Object.freeze({
  "masonry.brickwork": brickworkRail,
  "finish.plaster": plasterRail,
  "finish.paint": paintRail,
});
