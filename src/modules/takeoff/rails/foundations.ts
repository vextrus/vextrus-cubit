// The FOUNDATIONS area's rails — empty until M3 writes it (AM-11).
//
// M3's foundations rail writes its rails HERE. The barrel `./index.ts` already enumerates this file, so a kind
