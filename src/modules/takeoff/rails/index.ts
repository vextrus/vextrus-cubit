...
//
// Composed rather than spread: more than one area measures a kind — the frame's beams and the slab
// area's plates are both `rcc.concrete` — and a spread would keep the last area's rail and lose the
// others in silence, so the roster would claim a kind is measured while half of it never is
// (`enumerateRails`, AM-11, B-19).
