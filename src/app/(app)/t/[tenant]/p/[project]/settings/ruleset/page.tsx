...
export default async function ProjectRulesetSettings({ params }: { params: Promise<{ tenant: string; project: string }> }) {
  ...
  // The frame — the settings areas on the left, this screen's content on the right — is the
  // layout's (sub-navigation I-258), so this route renders its section and no nav of its own.
