...
export function ViewerScreen({ tenantId, projectId, drawingId, layoutName, initialViewport, initialSelection, initialLine = null, head: supplied, calibration: suppliedCalibration, scale: suppliedScale }: ViewerScreenProps) {
  ...
  return (
    <div className="cx-viewer" ref={setScreenRoot} data-testid={TESTIDS.viewer.screen} data-project={projectId} data-flyto={trace.flyto ?? undefined} data-flyto-flight={trace.flight === 0 ? undefined : String(trace.flight)} data-trace-basis={line.basis}>
