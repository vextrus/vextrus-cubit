...
export function SessionList() {
  ...
  return (
    <>
      ...
      {/* Both things this slot can hold are alerts of their own — the fault card claims `role=alert`
          and the refusal state's role is the primitive's — and an alert announces on insertion by
          definition. A live region wrapped around them would nest an assertive region inside a
          polite one, which is the one shape the algorithm has no single answer for: the changed node
