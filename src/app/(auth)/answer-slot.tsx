 ...
 * screen was reached with, passed by the screens a mailed link addresses: a refusal resolved on
 * this same screen has to lead back to it as it actually is, token and all (R-UI-020).
 */
