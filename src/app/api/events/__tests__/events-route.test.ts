...
describe("AC-1(b): the stream carries every recorded seq exactly once", () => {
  // The prior increment's law, unchanged by the door: a log that holds something is streamed from
  // that history, and the door is not what decides it (the seam answers `false` throughout).
