// The DOCS area's own refusals — empty until M3 writes it (AM-11).
//
// M3's documents area registers its codes HERE. The barrel `src/core/errors.ts` already enumerates this
...
export type DocsRefusalCode = never;
