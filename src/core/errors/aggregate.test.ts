 ...
 * main, 127 together — and the digest below is the merged tree's own, read off this file's run and
 * never spliced from the two sides' values. The branch's previous digest was
