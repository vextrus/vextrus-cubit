// The MASONRY rail's own refusals — empty until M3 writes it (AM-11).
//
// M3's masonry rail registers its codes HERE. The barrel `src/core/errors.ts` already enumerates this
...
export type MasonryRefusalCode = never;
