// SEAM-TENANT: the REBAR area's tables — empty until M3 writes them (AM-11).
//
// M3's rebar rail declares its tables HERE, and re-exports them from `db/schema/rebar.ts` for the drift
