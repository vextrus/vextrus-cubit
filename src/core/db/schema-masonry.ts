// SEAM-TENANT: the MASONRY area's tables — empty until M3 writes them (AM-11).
//
// M3's masonry rail declares its tables HERE, and re-exports them from `db/schema/masonry.ts` for the drift
