// SEAM-TENANT: the BOQ area's tables — empty until M3 writes them (AM-11).
//
// M3's bill-of-quantities area declares its tables HERE, and re-exports them from `db/schema/boq.ts` for the drift
