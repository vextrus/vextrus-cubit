// SEAM-TENANT: the SLABS area's tables — empty until M3 writes them (AM-11).
//
// M3's slabs rail declares its tables HERE, and re-exports them from `db/schema/slabs.ts` for the drift
