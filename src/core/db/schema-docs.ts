// SEAM-TENANT: the DOCS area's tables — empty until M3 writes them (AM-11).
//
// M3's documents area declares its tables HERE, and re-exports them from `db/schema/docs.ts` for the drift
