...
export const REFUSALS = {
  ...
  AUTH_EMAIL_UNREADABLE: {
    code: 'AUTH_EMAIL_UNREADABLE',
    message: 'That is not an address this product can read.',
    remedy: 'Check the spelling — an address looks like name@example.com.',
    severity: 'refusal',
    surface: 'field',
  },
  AUTH_REQUEST_FAILED: {
    ...
    remedy: 'Check what you entered and try again; if it keeps happening, report this code.',
    severity: 'error',
    surface: 'in-place',
  },
  ...
  TENANT_NAME_UNREADABLE: {
    code: 'TENANT_NAME_UNREADABLE',
    message: 'No address can be derived from that name.',
    remedy: 'Use a name carrying at least one letter or digit — the address is derived from it.',
    severity: 'refusal',
    surface: 'field',
  },
