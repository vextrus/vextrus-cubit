// The DOCS method area — empty until M3 writes it (AM-11).
//
// M3's documents area declares its methods HERE: a `*.methods.json` shard recorded beside the code it
...
export const DOCS_METHODS: MethodArea = Object.freeze({
