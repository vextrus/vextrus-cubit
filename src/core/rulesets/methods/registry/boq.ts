// The BOQ method area — empty until M3 writes it (AM-11).
//
// M3's bill-of-quantities area declares its methods HERE: a `*.methods.json` shard recorded beside the code it
...
export const BOQ_METHODS: MethodArea = Object.freeze({
