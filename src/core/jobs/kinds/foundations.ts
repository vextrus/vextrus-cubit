// The FOUNDATIONS area's own job kinds — empty until M3 writes it (AM-11).
//
// M3's foundations rail declares its kinds HERE. The barrel `src/core/jobs/kinds.ts` already enumerates this
...
export const FOUNDATIONS_JOB_KINDS = Object.freeze({}) satisfies JobKindGroup;

/** What this area's kinds are enqueued with (SEAM-JOBS: "typed payloads"). */
export type FoundationsJobPayloads = Record<never, never>;
