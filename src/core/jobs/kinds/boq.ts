// The BOQ area's own job kinds — empty until M3 writes it (AM-11).
//
// M3's bill-of-quantities area declares its kinds HERE. The barrel `src/core/jobs/kinds.ts` already enumerates this
...
export const BOQ_JOB_KINDS = Object.freeze({}) satisfies JobKindGroup;

/** What this area's kinds are enqueued with (SEAM-JOBS: "typed payloads"). */
export type BoqJobPayloads = Record<never, never>;
