// The FRAME area's own job kinds — empty until M3 writes it (AM-11).
//
// M3's frame rail declares its kinds HERE. The barrel `src/core/jobs/kinds.ts` already enumerates this
...
export const FRAME_JOB_KINDS = Object.freeze({}) satisfies JobKindGroup;

/** What this area's kinds are enqueued with (SEAM-JOBS: "typed payloads"). */
export type FrameJobPayloads = Record<never, never>;
