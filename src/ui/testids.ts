...
export const TESTIDS = {
  ...
  schedules: {
    ...
    sheetRow: "schedules-sheet-row",
    sheets: "schedules-sheets",
    standing: "schedules-standing",
    table: "schedules-table",
    transcribe: "schedules-transcribe",
    variant: "schedules-variant",
    zone: "schedules-zone",
  },
  scrollarea: {
  ...
  shell: {
    ...
    toolbarSlot: "shell-toolbar-slot",
    topbar: "shell-topbar",
    user: "shell-user",
  ...
  takeoff: {
    ...
    navSchedules: "takeoff-nav-schedules",
  },
  theme: {
  ...
  viewer: {
    ...
    layersToggle: "viewer-layers-toggle",
