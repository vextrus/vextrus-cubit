...
export const PRIMITIVES_STRINGS = Object.freeze({
  ...
  'primitives.combobox.loading': 'Loading options',
  /** The Combobox when the loader resolved to nothing for what was typed. */
  'primitives.combobox.empty': 'No matches',
  /** The accessible name of the Combobox listbox, which has no visible label of its own. */
  'primitives.combobox.list': 'Suggestions',
