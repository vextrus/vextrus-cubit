...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>(function NumberInput(
  { value, onValueChange, unit, className, onFocus, onBlur, ...rest },
  ref,
) {
  const [editing, setEditing] = useState(false);

  return (
    <div className="datum-number-input">
      <input
        ref={ref}
      ...
      />
      {unit === undefined ? null : (
        <span data-testid="number-input-suffix" className="datum-number-suffix">
          {unit}
        </span>
      )}
    </div>
