...
export const schedules = {
  ...
  // What a rail row says a sheet holds — the muted words beside the sheet's own name (§1).
  ...
  // I-253's three sections, in the order a reader needs them: what stands, what was read, what is
  // offered.
