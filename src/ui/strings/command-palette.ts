// The palette's chrome, verbatim from docs/design/command-palette.md §3 (R-SPINE-060). Item and
// group copy that names the workspace's own subjects arrives in props: a project's name is the
// workspace's data, not this table's.
