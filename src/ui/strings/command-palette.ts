// R-SPINE-060: the ⌘K palette's own chrome copy, verbatim from docs/design/command-palette.md §3.
// Item and group labels that name a person's own data (a project, a drawing, a sheet, a set) are
// that data and arrive in props; everything the palette says in its own voice is here.
export const commandPalette = {
  ...
  command_palette_reason_area_unbuilt: "This area has no screen in this workspace yet.",
