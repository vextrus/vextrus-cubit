...
export const viewer = {
  ...
  viewer_layer_isolate_label: "Isolate {layer}",
  viewer_layer_lock: "Lock",
  viewer_layer_lock_label: "Lock {layer}",
  viewer_layer_retry: "Retry layer",
  viewer_canvas_label: "Sheet {layout}",
  viewer_canvas_keys: "Drag to pan, scroll to zoom. Plus and minus zoom, the arrow keys pan, and F fits the sheet.",
  ...
  viewer_empty_unread_body:
    "A sheet appears here once the drawing has been read. Reading starts when the drawing is uploaded and finishes on its own.",
